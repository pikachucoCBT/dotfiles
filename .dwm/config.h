...
static const char *fonts[]          = { "DinaRemasterII:size=12", "NotoColorEmoji:size10:antialias=true:autohint=true",  "FontAwesome:size=12" };
...
static const Rule rules[] = {
	...
	{ "St",        NULL,     NULL,           0,         0,          1,           0,        -1 },
        { "weatherterm", NULL,   NULL,           0,         1,          1,           0,        -1 },
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,      Button3,        spawn,          SHCMD(TERMINAL " -e vim ~/.dwmblocks-async/config.h") },
};
